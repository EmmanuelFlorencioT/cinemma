...
<body>
    ...
    <div class="admin-intro">
      <h2>Welcome Admin,</h2>
      <p>Select any movie and program a screening in the movie theatre of your choice.</p>
    </div>

    <div class="row mt-4 movie-list-admin text-center">
        <?php
        foreach($movies["results"] as $movieItem){
            echo "<div class='col-md-3 col-sm-4'>
                <a href='./admin-movie.php?id=".$movieItem['id']."'>
                <div class='movie'>
